...
if (isset($_FILES['uploadFile'])) {
    ...
    $result = $LicenceManager->AuthenticateLicence($data, $accessLogInformation);
    if (!$result) {
...
<body class="upload">
    ...
    <div class="container text-center">
        ...
        <form name="authenticateLicenceForm" action="./authenticateLicence.php" method="post" enctype="multipart/form-data">
            <div class="big-button-space">
                <p>1.システムのライセンス認証申請ファイル選択</p>
                <div>
                    ...
                    <button type="button" class="btn btn-success btn-large big-button" value="ファイル選択" onClick="$('#upload-file').click();">ライセンス認証申請<br>ファイル選択</button>
                </div>
                <div>
            ...
            <div class="big-button-space">
                <p>2.ライセンス認証ファイル発行ボタンを選択</p>
                <button class="btn btn-info btn-large big-button" type="button" onclick="fileExtensionCheck();">ライセンス認証<br>ファイル発行</button>
            </div>
        </form>
        <div class="go-back">
    ...
    <script src="./js/authenticateLicence.js"></script>
</body>
</html>
